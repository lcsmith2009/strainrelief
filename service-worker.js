const CACHE_NAME="strainrelief-v80";
const APP_SHELL=["./","./index.html","./style.css","./app.js","./manifest.json","./logo.png","./logo-wide.png","./logo-hero.png","./icon-192.png","./icon-512.png"];
