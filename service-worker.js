const CACHE_NAME="strainrelief-v90";
const APP_SHELL=["./","./index.html","./style.css","./app.js","./manifest.json","./logo.png","./logo-hero.png","./logo-mark.png","./icon-192.png","./icon-512.png"];
