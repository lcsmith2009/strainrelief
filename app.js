...
const strainSeeds = [
["Harlequin","🌱","img-cbd","CBD-dominant Hybrid"],
["ACDC","🍃","img-cbd","CBD-dominant Hybrid"],
["Cannatonic","🌿","img-cbd","Balanced THC/CBD Hybrid"],
["Northern Lights","🌙","img-night","Indica"],
["Blue Dream","💚","img-day","Balanced Hybrid"],
["Granddaddy Purple","🌌","img-night","Indica"],
["Sour Diesel","⚡","img-bright","Sativa"],
["Girl Scout Cookies","🍪","img-dessert","Hybrid"],

["Pineapple Express","🍍","img-day","Hybrid"],
["Jack Herer","🌸","img-bright","Sativa-dominant"],
["Purple Punch","🫐","img-night","Indica"],
["Lemon Haze","🍋","img-bright","Sativa-dominant"],
["Ringo's Gift","🎁","img-cbd","CBD-dominant Hybrid"],
["Charlotte's Web","🕊️","img-cbd","CBD-dominant"],
["Maui Wowie","🏝️","img-bright","Sativa"],
["Durban Poison","☀️","img-bright","Sativa"],
["White Widow","🕸️","img-day","Balanced Hybrid"],
["Wedding Cake","🎂","img-dessert","Indica-dominant"],
["Gelato","🍨","img-dessert","Hybrid"],
["OG Kush","🌲","img-night","Hybrid"],
["Bubba Kush","🛳️","img-night","Indica"],
["Zkittlez","🌈","img-dessert","Indica-leaning Hybrid"],
["Super Silver Haze","✨","img-bright","Sativa"],
["Green Crack","🟢","img-bright","Sativa"],
["LA Confidential","🌆","img-night","Indica"],
["Remedy","🧘","img-cbd","CBD-dominant"],
["Pennywise","🪙","img-cbd","Balanced THC/CBD"],
["Mango Kush","🥭","img-dessert","Indica-leaning Hybrid"],
["Strawberry Cough","🍓","img-bright","Sativa"],

["Runtz","🍬","img-dessert","Balanced Hybrid"],
["Ice Cream Cake","🍰","img-dessert","Indica-dominant"],
["Mimosa","🍊","img-day","Sativa-dominant Hybrid"],
["Skywalker OG","🚀","img-night","Indica-dominant Hybrid"],
["Apple Fritter","🍏","img-dessert","Balanced Hybrid"],
["MAC 1","🧪","img-day","Balanced Hybrid"],
["Do-Si-Dos","🍩","img-night","Indica-dominant Hybrid"],
["Lemon Cherry Gelato","🍒","img-dessert","Balanced Hybrid"],

["Chemdawg","🛢️","img-bright","Hybrid"],
["Forbidden Fruit","🍇","img-dessert","Indica"],
["Gorilla Glue #4","🦍","img-night","Hybrid"],
["Animal Mints","🌿","img-dessert","Hybrid"],
["Cherry Pie","🥧","img-dessert","Hybrid"],
["Sunset Sherbet","🌅","img-dessert","Hybrid"],
["Tahoe OG","🏔️","img-night","Indica-dominant"],
["Banana Kush","🍌","img-dessert","Hybrid"],
["Bruce Banner","💥","img-bright","Hybrid"],
["Cereal Milk","🥛","img-dessert","Balanced Hybrid"]
];
